      ...
      <div className="career-container">
        ...
        <div className="career-info">
          ...
          <div className="career-info-box">
            <div className="career-info-in">
              <div className="career-role">
                <h4>Softwareentwickler (Web & E-Commerce)</h4>
          ...
          <div className="career-info-box">
            <div className="career-info-in">
              <div className="career-role">
                <h4>Full-Stack Entwickler & IT Administration</h4>
          ...
          <div className="career-info-box">
            <div className="career-info-in">
              <div className="career-role">
                <h4>Frontend- / Softwareentwickler</h4>
          ...
          <div className="career-info-box">
            <div className="career-info-in">
              <div className="career-role">
                <h4>Full-Stack Entwickler (E-Commerce)</h4>
